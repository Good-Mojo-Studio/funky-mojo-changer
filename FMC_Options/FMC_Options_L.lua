VDW.FMC.Local = VDW.FMC.Local or (function()
	local base = {
		TIP_CLOSE_PANEL = "Close this panel!",
-- tab --
		T_TIP = "Options for %s",
		T_S_BUTTONS = "Specialization Buttons",
		T_L_BUTTONS = "Loot Buttons",
		T_T_BUTTONS = "Talent Buttons",
-- box --
		BOX_TITLE = "Visibility and Size",
-- widget --
		...
		W_DIRECTION_TIP = "Choose the direction of the Talents Popout Button.",
		W_STYLE = "Style",
		W_S_TIP = "What kind of style do you want the %s to be?",
		W_BANNER_ART = "Banner art",
		W_ATTACH_TIP = "Check me! if you want to %s",
		W_ATTACH = "attach animation to cast bar.",
-- profiles --
		P_TAB = "Profiles",
		...
		P_NOTES = "When you create or load or delete a profile the game will restart!",
-- notes --
		NOTES_HIDE_SHOW_BUTTONS = "When you hide or show the buttons the game will restart!",
		NOTES_UP_DOWN_BUTTONS = "When you choose the direction of the buttons the game will restart!",
		NOTES_CHANGE_TALENTS = "Please! When you change a talent loadout or when you create a new talent loadout or when you delete a talent load please restart (/reload) the game, so the talent popout buttons will work properly!",
	}
	local o = {
		frFR = {
...
-- tab --
			...
			T_S_BUTTONS = "Boutons de spécialisation",
			T_L_BUTTONS = "Boutons de butin",
			T_T_BUTTONS = "Boutons de talents",
-- box --
			BOX_TITLE = "Visibilité et taille",
-- widget --
			...
			W_SLIDER = "Taille: %d",
			W_DIRECTION = "Direction",
			W_DIRECTION_TIP = "Choisissez la direction du bouton escamotable des talents.",
			W_STYLE = "Style",
			W_S_TIP = "Quel style voulez-vous pour %s ?",
			W_BANNER_ART = "Illustration de la bannière",
			W_ATTACH_TIP = "Cochez-moi si vous voulez %s",
			W_ATTACH = "Attacher à la barre d’incantation",
-- profiles --
			P_TAB = "Profils",
...
-- tab --
			...
			T_S_BUTTONS = "Spezialisierungs-Schaltflächen",
			T_L_BUTTONS = "Beute-Schaltflächen",
			T_T_BUTTONS = "Talent-Schaltflächen",
-- box --
			BOX_TITLE = "Sichtbarkeit und Größe",
-- widget --
			...
			W_DIRECTION_TIP = "Wähle die Richtung der Talent-Popout-Schaltfläche.",
			W_STYLE = "Stil",
			W_S_TIP = "Welchen Stil möchtest du für %s?",
			W_BANNER_ART = "Banner-Grafik",
			W_ATTACH_TIP = "Hake mich an, wenn du %s möchtest",
			W_ATTACH = "An Zauberleiste anheften",
-- profiles --
			P_TAB = "Profile",
...
-- tab --
			...
			T_S_BUTTONS = "Botones de especialización",
			T_L_BUTTONS = "Botones de botín",
			T_T_BUTTONS = "Botones de talentos",
-- box --
			BOX_TITLE = "Visibilidad y tamaño",
-- widget --
			...
			W_DIRECTION_TIP = "Elige la dirección del botón desplegable de talentos.",
			W_STYLE = "Estilo",
			W_S_TIP = "¿Qué estilo quieres para %s?",
			W_BANNER_ART = "Arte del estandarte",
			W_ATTACH_TIP = "Márcame si quieres %s",
			W_ATTACH = "Anclar a la barra de lanzamiento",
-- profiles --
			P_TAB = "Perfiles",
...
-- tab --
			T_TIP = "Opções para %s",
			T_S_BUTTONS = "Botoes de especializacao",
			T_L_BUTTONS = "Botoes de saque",
			T_T_BUTTONS = "Botoes de talentos",
-- box --
			BOX_TITLE = "Visibilidade e tamanho",
-- widget --
			...
			W_SLIDER = "Tamanho: %d",
			W_DIRECTION = "Direção",
			W_DIRECTION_TIP = "Escolha a direção do botão recolhível de talentos.",
			W_STYLE = "Estilo",
			W_S_TIP = "Que estilo você quer para %s?",
			W_BANNER_ART = "Arte do estandarte",
			W_ATTACH_TIP = "Marque-me se você quiser %s",
			W_ATTACH = "Anexar à barra de conjuração",
-- profiles --
			P_TAB = "Perfis",
...
-- tab --
			T_TIP = "Opzioni per %s",
			T_S_BUTTONS = "Pulsanti di specializzazione",
			T_L_BUTTONS = "Pulsanti del bottino",
			T_T_BUTTONS = "Pulsanti dei talenti",
-- box --
			BOX_TITLE = "Visibilita e dimensione",
-- widget --
			...
			W_SLIDER = "Dimensione: %d",
			W_DIRECTION = "Direzione",
			W_DIRECTION_TIP = "Scegli la direzione del pulsante a comparsa dei talenti.",
			W_STYLE = "Stile",
			W_S_TIP = "Che stile vuoi per %s?",
			W_BANNER_ART = "Grafica dello stendardo",
			W_ATTACH_TIP = "Aggancia alla barra di lancio",
			W_ATTACH = "Aggancia alla barra di lancio",
-- profiles --
			P_TAB = "Profili",
...
-- notes --
			NOTES_HIDE_SHOW_BUTTONS = "When you hide or show the buttons the game will restart!",
			NOTES_UP_DOWN_BUTTONS = "When you choose the direction of the buttons the game will restart!",
			NOTES_CHANGE_TALENTS = "Please! When you change or create or delete a talent load please restart (/reload) the game, so the talents popout buttons will work properly!",
		},
		ruRU = base,
		zhCN = base,
		zhTW = base,
