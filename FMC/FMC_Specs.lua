...
local function CreateButtons()
	for i = 1, (GetNumSpecializations() - 1), 1 do
		...
		if i == 1 then
			_G["fmcButtonSpec"..i]:SetScript("OnClick", function (self, button, down)
				if button == "LeftButton" and down == false then
					...
					PlaySound(SOUNDKIT.PUT_DOWN_GEMS, "Master")
				end
			end)
		elseif i == 2 then
			_G["fmcButtonSpec"..i]:SetScript("OnClick", function (self, button, down)
...
-- buttons background tooltip
local function ButtonBackgroundTooltip()
	if GetSpecialization() == 1 then
